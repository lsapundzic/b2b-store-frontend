...
export const GET_SINGLE_ENTRY = `${BASE_URL}/spaces/${process.env.SPACE_ID}/environments/master/entries/${ABOUT_ID}?access_token=${process.env.DELIVERY_ACCESS_TOKEN}`;
